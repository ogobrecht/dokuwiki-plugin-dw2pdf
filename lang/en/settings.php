...
$lang['removelinkspattern']      = 'Remove links, which url matches the regular expression pattern - example:  <code>/securedHost.myCompany.tld/i</code>, see also <a href="http://www.phpliveregex.com/">phpliveregex.com</a>';
$lang['removelinkscomment']      = 'The string, which should be appended to the name of the removed link - example: <code> (link to secured host removed)</code>';
